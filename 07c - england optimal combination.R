...
#Import data
lc_decile_sex = readRDS("england_models/lc_decile_sex.rds")
eng_mort_decile_sex = readRDS("england_models/eng_mort.rds")
eng_mort_decile_total = readRDS("england_models/eng_mort_decile_total.rds")
...
# saveRDS(lc_all, "england_models/lc_all.rds")
...
St_list = readRDS("england_models/St_list.rds")
names(St_list) = years
...
# saveRDS(R_forecasts_oc, "england_models/forecasts_oc.rds")
