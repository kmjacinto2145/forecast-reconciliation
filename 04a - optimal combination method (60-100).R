...
lc_total_60 = readRDS("models/lc_total_60.rds")
...
lc_total_regions = lc_total_60[2:length(lc_total_60)]
lc_total_japan = list(lc_total_60[[1]])
...
saveRDS(revised_forecasts_all, file = "forecasts/optimal_comb_60.rds")
